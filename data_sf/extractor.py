...
for each_link in all_datasets:
    if each_link["scraped"] or not each_link["possible"]:
        continue
    os.chdir(
        "C:\\Users\\Ishwor\\Desktop\\upwork\\scraping_charles\\data\\1st_batch_100k\\data_sf"
    )
    try:
        ...
        os.chdir("C:\\Users\\Ishwor\\Desktop\\upwork\\scraping_charles\\data_sf")
        with open("links_datasets.json", "w") as file:
