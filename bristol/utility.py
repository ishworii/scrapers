...
def save_everything(
    ...
    melbourne_list = set(
        os.listdir(
            r"C:\Users\Ishwor\Desktop\upwork\scraping_charles\data\processed_data"
        )
    )

    if "tree_canopies" in table_name or table_name in melbourne_list:
        logging.info("Table already in melbourne")
        return -1
